...
namespace ZeroProximity.Controls
{
    ...
    public class Accordion : ItemsControl, IUpdateVisualState
    {
            ...
            if (accordionItem != null)
            {
                ...
                if (accordionItem.ContentTemplate == null)
                {
                    accordionItem.SetBinding(
                        ...
                        new Binding()
                        {
                            Path = new PropertyPath("ContentTemplate"),
                            Source = this,
                ...
                if (accordionItem.AccordionButtonStyle == null)
                {
                    accordionItem.SetBinding(
                        ...
                        new Binding()
                        {
                            Path = new PropertyPath(AccordionButtonStyleName),
                            Source = this,
                            Mode = BindingMode.OneWay
                        });
                }
        ...
        protected async override void ClearContainerForItemOverride(DependencyObject element, object item)
        {
            AccordionItem accordionItem = element as AccordionItem;
            if (accordionItem != null)
            {
